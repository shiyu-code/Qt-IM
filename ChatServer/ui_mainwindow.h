...
public:
    ...
    void setupUi(QWidget *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/resource/images/ic_app.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QString::fromUtf8(":/resource/images/ic_cancel.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QString::fromUtf8(":/resource/images/ic_ok.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnUserInfoPage->setObjectName(QString::fromUtf8("btnUserInfoPage"));
        btnUserInfoPage->setFocusPolicy(Qt::NoFocus);
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/resource/images/ic_find.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnScorePage->setObjectName(QString::fromUtf8("btnScorePage"));
        btnScorePage->setFocusPolicy(Qt::NoFocus);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/resource/images/ic_goods.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnScoreInsertPage->setObjectName(QString::fromUtf8("btnScoreInsertPage"));
        ...
        btnUsersPage->setObjectName(QString::fromUtf8("btnUsersPage"));
        btnUsersPage->setFocusPolicy(Qt::NoFocus);
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/resource/images/if_users.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnPasswordPage->setObjectName(QString::fromUtf8("btnPasswordPage"));
        btnPasswordPage->setFocusPolicy(Qt::NoFocus);
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/resource/images/ic_key.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon9;
        icon9.addFile(QString::fromUtf8(":/resource/images/ic_backup.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon10;
        icon10.addFile(QString::fromUtf8(":/resource/images/ic_exit.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        stackedWidgetFunc->setObjectName(QString::fromUtf8("stackedWidgetFunc"));
        page = new QWidget();
        ...
        lineEditUserEmail->setObjectName(QString::fromUtf8("lineEditUserEmail"));
...
"}"));
        ...
        lineEditUserPhone->setObjectName(QString::fromUtf8("lineEditUserPhone"));
        ...
        lineEditUserGroup->setObjectName(QString::fromUtf8("lineEditUserGroup"));

        gridLayout_3->addWidget(lineEditUserGroup, 2, 1, 1, 2);

        lineEditAddUser = new QLineEdit(groupBox_5);
        lineEditAddUser->setObjectName(QString::fromUtf8("lineEditAddUser"));
        ...
        btnUserInsert->setObjectName(QString::fromUtf8("btnUserInsert"));
        btnUserInsert->setFocusPolicy(Qt::NoFocus);
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/resource/images/ic_add.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnUserInsert->setIcon(icon11);

        gridLayout_2->addWidget(btnUserInsert, 0, 0, 1, 1);

        btnUserRefresh = new QPushButton(groupBox_5);
        btnUserRefresh->setObjectName(QString::fromUtf8("btnUserRefresh"));
        btnUserRefresh->setFocusPolicy(Qt::NoFocus);
        QIcon icon12;
        icon12.addFile(QString::fromUtf8(":/resource/images/ic_refresh.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon13;
        icon13.addFile(QString::fromUtf8(":/resource/images/ic_edit.png"), QSize(), QIcon::Normal, QIcon::Off);
        btnUserEdit->setIcon(icon13);

        gridLayout_2->addWidget(btnUserEdit, 1, 0, 1, 1);

        btnUserDelete = new QPushButton(groupBox_5);
        btnUserDelete->setObjectName(QString::fromUtf8("btnUserDelete"));
        btnUserDelete->setFocusPolicy(Qt::NoFocus);
        QIcon icon14;
        icon14.addFile(QString::fromUtf8(":/resource/images/ic_delete.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        lineEditOldPasswd->setObjectName(QString::fromUtf8("lineEditOldPasswd"));
        ...
        lineEditNewPasswd->setObjectName(QString::fromUtf8("lineEditNewPasswd"));
        ...
        lineEditNewPasswd2->setObjectName(QString::fromUtf8("lineEditNewPasswd2"));
        ...
        btnPasswdChange->setObjectName(QString::fromUtf8("btnPasswdChange"));
        ...
        lineEditBackup->setObjectName(QString::fromUtf8("lineEditBackup"));
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/resource/images/ic_data_backup.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        btnDataUdo->setObjectName(QString::fromUtf8("btnDataUdo"));
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/resource/images/ic_data_udo.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        labelHostAddr->setObjectName(QString::fromUtf8("labelHostAddr"));

        horizontalLayout_5->addWidget(labelHostAddr);

        labelSystemTime = new QLabel(widgetStatus);
        labelSystemTime->setObjectName(QString::fromUtf8("labelSystemTime"));
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "\345\261\200\345\237\237\347\275\221\351\200\232\344\277\241\347\256\241\347\220\206\347\263\273\347\273\237", nullptr));
